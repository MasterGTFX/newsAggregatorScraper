...
class TestTvn24Scraper(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.scraper_base = Tvn24(check_scraped_ids=False, use_database=False)

        cls.scraper_with_items = Tvn24(check_scraped_ids=False, use_database=False)
        cls.scraper_with_items.scrape_more_items(scrape_articles=False, save_to_file=False)

        cls.scraper_with_items_and_articles = Tvn24(check_scraped_ids=False, use_database=False)
